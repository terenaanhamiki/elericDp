...
const BEST_MODELS = [
  // Google Gemini (100% FREE - 1500 requests/day) - Using proven stable models
  { value: 'gemini-1.5-flash-latest', label: 'Gemini 1.5 Flash (FREE)', provider: 'Google', icon: 'i-ph:google-logo' },
  { value: 'gemini-1.5-pro-latest', label: 'Gemini 1.5 Pro (FREE)', provider: 'Google', icon: 'i-ph:google-logo' },
  { value: 'gemini-2.0-flash-exp', label: 'Gemini 2.0 Flash Exp (FREE)', provider: 'Google', icon: 'i-ph:google-logo' },
