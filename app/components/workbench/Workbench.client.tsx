...
// Import canvas integration functions
import { initializeCanvasIntegration, syncActivePageWithEditor } from '~/lib/stores/canvas-integration';
...
// Removed: Code/Canvas slider - defaulting to Canvas only view
...
export const Workbench = memo(
  ({
    ...
    useEffect(() => {
      // Initialize canvas integration to watch for file changes
      initializeCanvasIntegration();

      // Sync active page between canvas and editor
      syncActivePageWithEditor();
    }, []);
    ...
    // Auto-set to canvas view on mount
    useEffect(() => {
      workbenchStore.currentView.set('canvas');
    }, []);
            ...
            <div className="absolute inset-0 px-2 lg:px-4">
              <div className="h-full flex flex-col bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor shadow-sm rounded-lg overflow-hidden">
                <div className="flex items-center px-3 py-2 border-b border-bolt-elements-borderColor gap-1.5">
                  ...
                  />
                  {/* REMOVED: Code/Canvas Slider - Canvas is now the default and only view */}
                ...
                <div className="relative flex-1 overflow-hidden">
                  {/* REMOVED: Code Editor Panel - Code will be shown in modal from canvas cards */}
                  ...
                  {/* Canvas is now always visible - no view switching needed */}
                  <InfiniteCanvas />
                </div>
              </div>
            </div>
